...
var wordsSettings = {
	...
	offsetY:12,
	color:'#486EDD',
	colorNotExist:'#FF0000',
	bgColor:'#C4D6E8',
	bgColorCorrect:'#12B882',
	bgColorPosition:'#E7D431',
	bgColorNotExist:'#E9ECEF',
...
var shareTitle = 'Highscore on Guess Word is [SCORE]points';//social share score title
var shareMessage = '[SCORE]Points is mine new highscore on Guess Word game! Try it now!'; //social share score message
	...
	for(var n=0; n<key_arr.length; n++){
		for(var k=0; k<key_arr[n].length; k++){
			if(gameData.keyboard.notexist.indexOf(key_arr[n][k]) != -1){ 
				// $.key[n+'_'+k+'_bg'].fillCommand.style = wordsSettings.bgColorNotExist; // For disabled looking key background
				$.key[n+'_'+k].alpha = 0.3;
